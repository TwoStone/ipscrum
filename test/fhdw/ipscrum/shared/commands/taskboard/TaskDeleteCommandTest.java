...
/**
 * The class <code>TaskDeleteCommandTest</code> contains tests for the class <code>{@link TaskDeleteCommand}</code>.
 */
public class TaskDeleteCommandTest {
	...
	/**
	 * Run the TaskDeleteCommand(Task) constructor test.
	 * 
	 * @throws Exception
	 *             if one of the used methods fails
	 */
	@Test
	public void testTaskDeleteCommand1() throws Exception {
		final Task task1 = this.t1;

		final TaskDeleteCommand result = new TaskDeleteCommand(task1);
	...
	public void testAccept1() throws Exception {
		final TaskDeleteCommand fixture = new TaskDeleteCommand(this.t6);
	...
	public void testDependsOnProject1() throws Exception {
		final TaskDeleteCommand fixture = new TaskDeleteCommand(this.t1);
