...
/**
 * The class <code>ListFieldAddValueCommandTest</code> contains tests for the class
 * <code>{@link ListFieldAddValueCommand}</code>.
 */
public class ListFieldAddValueCommandTest {
	...
	/**
	 * Run the ListFieldAddValueCommand<Serializable> createCommand(ListField<T>,T,Ticket) method test.
	 * 
	 * @throws Exception
	 *             if one of the used methods fails
	 */
	...
	public void testCreateCommand1() throws Exception {
		...
		final ListFieldAddValueCommand<Serializable> result =
				ListFieldAddValueCommand.createCommand(field, this.sprint, ticket);
	...
	public void testCreateCommand3() throws Exception {
		...
		final ListFieldAddValueCommand<String> result =
				ListFieldAddValueCommand.createCommand(this.pbi1HintsField, "NewName", this.pbi1);
	...
	public void testDependsOnProject1() throws Exception {
		...
		final ListFieldAddValueCommand fixture =
				new ListFieldIdentifiableObjectAddValueCommand(this.listField, this.sprint, this.pbi1);
	...
	public void testGetDependingProject1() throws Exception {
		@SuppressWarnings({ "unchecked", "rawtypes" })
		final ListFieldAddValueCommand fixture =
				new ListFieldIdentifiableObjectAddValueCommand(this.listField, this.per2, this.pbi3);
	...
	public void testGetDependingProject2() throws Exception {
		@SuppressWarnings({ "rawtypes", "unchecked" })
		final ListFieldAddValueCommand fixture =
				new ListFieldIdentifiableObjectAddValueCommand(this.listField, this.team1, this.pbi4);
	...
	public void testGetTicket2() throws Exception {
		@SuppressWarnings({ "rawtypes", "unchecked" })
		final ListFieldAddValueCommand fixture =
				new ListFieldIdentifiableObjectAddValueCommand(this.listField, this.sprint, this.pbi4);
		final Model model1 = new Model(new Date());
	...
	public void testOnExecute2() throws Exception {
		@SuppressWarnings({ "rawtypes", "unchecked" })
		final ListFieldAddValueCommand fixture =
				new ListFieldIdentifiableObjectAddValueCommand(this.listField, this.pbi1, this.pbi2);
		final Model model1 = new Model(new Date());
	...
	public void testOnExecute3() throws Exception {
		@SuppressWarnings({ "rawtypes", "unchecked" })
		final ListFieldAddValueCommand fixture =
				new ListFieldIdentifiableObjectAddValueCommand(null, this.per2, this.pbi2);
	...
	public void testOnExecute4() throws Exception {
		@SuppressWarnings({ "rawtypes", "unchecked" })
		final ListFieldAddValueCommand fixture =
				new ListFieldIdentifiableObjectAddValueCommand(this.listField, this.per2, null);
		fixture.onExecute(this.model);
	...
	public void testOnExecute5() throws Exception {
		@SuppressWarnings({ "rawtypes", "unchecked" })
		final ListFieldAddValueCommand fixture =
				new ListFieldIdentifiableObjectAddValueCommand(this.listField, null, this.pbi2);
		fixture.onExecute(this.model);
