...
/**
 * This class represents the presenter which controls the view to create Incident Types.
 */
public class IncidentTypeCreatePresenter extends WritePresenter {
		...
		if (this.view == null) {
			...
			this.view.registerSave(new DefaultEventHandler() {
				...
				public void onUpdate(final Object sender, final EventArgs eventArgs) {
					IncidentTypeCreatePresenter.this.save();
	...
	public Boolean onSave() {
		try {
			this.doCommand(new IncidentTypeCreateCommand(this.view.getName()));
