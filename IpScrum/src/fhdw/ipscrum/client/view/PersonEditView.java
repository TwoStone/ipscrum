...
public class PersonEditView extends MasterView implements IPersonEditView {
	...
	public PersonEditView() {
		...
		saveButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(final ClickEvent event) {
				PersonEditView.this.saveEvent.fire(PersonEditView.this);
			}
		});
		...
		abortButton.addClickHandler(new ClickHandler() {
			...
			@Override
			public void onClick(final ClickEvent event) {
				PersonEditView.this.abortEvent.fire(PersonEditView.this);
			}
		});
	...
	@Override
	public void updateFields(final Person person) {
		this.firstNameTextBox.setText(person.getFirstname());
		this.lastNameTextBox.setText(person.getLastname());
	}
