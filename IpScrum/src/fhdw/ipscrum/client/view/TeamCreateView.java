...
/**
 * represents the view to create teams.
 */
public class TeamCreateView extends MasterView implements ITeamCreateView {
	...
	/**
	 * constructor of the TeamCreateView.
	 */
	public TeamCreateView() {
		...
		final HTML header = new HTML("<h3>Neues Team erstellen</h3>", true);
		...
		saveButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(final ClickEvent event) {
				TeamCreateView.this.saveEvent.fire(TeamCreateView.this);
			}
		});
		...
		abortButton.addClickHandler(new ClickHandler() {
			...
			@Override
			public void onClick(final ClickEvent event) {
				TeamCreateView.this.abortEvent.fire(TeamCreateView.this);
			}
		});
