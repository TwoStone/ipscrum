...
public interface IProjectView extends IView{
	...
	/**
	 * Method addNewProjectEventHandler
	 * Use this to register a handler for an event 
	 * which opens a new dialog to create a new {@link Project} 
	...
	/**
	 * Method addDeleteProjectEventHandler
	 * Use this to register a handler for an event 
	 * which deletes a {@link Project} 
	 * @param args from Type {@link EventHandler<EventArgs>}
	 */
	public abstract void addDeleteProjectEventHandler(EventHandler<ProjectEventArgs> arg);
	
	/**
	 * Method addProjectSelectionEventHandler
	 * Use this to register a handler for an event 
	 * which opens the {@link ProductBacklogView}, the {@link ReleaseView} 
	 * and the {@link SprintView} for the selected {@link Project}
	 * @param args from Type {@link EventHandler<EventArgs>}
	 */
	public abstract void addProjectSelectionHandler(EventHandler<ProjectEventArgs> arg);

	/**
	 * Method getMasterProductBacklogPanel
	 * Returns the MasterProductBacklogPanel
	 * @return Panel
	 */
	public abstract Panel getMasterProductBackloglPanel();
	
	/**
	 * Method getMasterReleasePanel
	 * Returns the MasterReleasePanel
	 * @return Panel
	 */
	public abstract Panel getMasterReleasePanel();
	
	/**
	 * Method getMasterSprintPanel
	 * Returns the MasterSprintPanel
	 * @return Panel
	 */
	public abstract Panel getMasterSprintPanel();
	
	/**
	 * Method getMasterSprintProductBacklogPanel
	 * Returns the MasterSprintProductBacklogPanel
	 * @return Panel
	 */
