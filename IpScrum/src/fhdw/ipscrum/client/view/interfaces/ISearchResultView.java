...
public interface ISearchResultView extends IView {
	...
	/**
	 * Registers handler to the ShowTicketEvent Event is raised, when user wants
	 * to see details for a ticket.
	 * 
	 * @param handler
	 */
	...
	/**
	 * Displays the specific view in a panel.
	 * 
	 * @param view
	 *            View to be displayed.
	 */
	void displayDetails(IView view);
