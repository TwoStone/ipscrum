 ...
 */
public class IncidentTypeCreateView extends MasterView implements IIncidentTypeCreateView {
	...
	public IncidentTypeCreateView() {
		...
		abortButton.addClickHandler(new ClickHandler() {
			...
			@Override
			public void onClick(final ClickEvent event) {
				IncidentTypeCreateView.this.abortEvent.fire(IncidentTypeCreateView.this);
			}
		});
