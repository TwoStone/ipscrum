 ...
 * <br />
 * Function of this class is to define the persistence 
 * handler once. So, while life-cycle only one persistence 
 * behavior will be used.<br />
 * <br />
 * At default XStream will be used for persistence.</p>
 */
public final class PersistenceManager implements PersistenceHandler {
	...
	private PersistenceManager() throws PersistenceException{
		this.handler = new XStreamHandler();
	}
	 ...
	 */
	private PersistenceManager(PersistenceHandler handler) {
	 ...
	 * <br /><br />
	 * <b>Attention</b>
	 * The first call of this method while program life-cycle 
	 * decides the functioning.
	 * <br /><br />
	 * If this method is called first, the default handler
	 * "XStream" will be used all the time no matter if
	 * getInstance() or getInstance(PersistenceHandlerInterface handler)
	 ...
	 * <b>Attention</b>
	 * The first call of this method while program life-cycle 
	 * decides the functioning an sets the given handler "handler" of
	 * type PersistenceHandlerInterface.
	 * <br /><br />
	 * If this method is called first, the given handler
	 * will be used all the time no matter if
	 * getInstance() or getInstance(PersistenceHandlerInterface handler)
	 * will be called another time.
	 */
	public static PersistenceManager getInstance(PersistenceHandler handler){
		if(instance == null){
