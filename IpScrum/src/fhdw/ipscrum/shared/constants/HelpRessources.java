 ...
 */
public abstract class HelpRessources {

	/**
	 * Base path to the application server that holds the documentation files.
	 */
	 ...
	 */
	public static final String STATETYPECREATEPRESENTER1 = "StateTypeCreatePresenter1.html";

	/**
	 * Topic: "Feld erstellen".
	 */
	public static final String FIELDTYPECREATEPRESENTER1 = "FieldTypeCreatePresenter1.html";
	...
	static {
		HelpRessources.PRESENTER_HELP.put("Willkommen", HelpRessources.WILLKOMMEN);
		HelpRessources.PRESENTER_HELP.put("AllgemeineEinfhrung", HelpRessources.ALLGEMEINEEINFHRUNG);
		HelpRessources.PRESENTER_HELP.put("StartderAnwendung", HelpRessources.STARTDERANWENDUNG);
		HelpRessources.PRESENTER_HELP.put("AnmeldungamSystem", HelpRessources.ANMELDUNGAMSYSTEM);
		HelpRessources.PRESENTER_HELP.put("Programmoberflche", HelpRessources.PROGRAMMOBERFLCHE);
		HelpRessources.PRESENTER_HELP.put("Handhabung", HelpRessources.HANDHABUNG);
		HelpRessources.PRESENTER_HELP.put("Projekt", HelpRessources.PROJEKT);
		HelpRessources.PRESENTER_HELP.put("ProjectSelectionPresenter", HelpRessources.PROJECTSELECTIONPRESENTER);
		HelpRessources.PRESENTER_HELP.put("ProjectCreatePresenter", HelpRessources.PROJECTCREATEPRESENTER);
		HelpRessources.PRESENTER_HELP.put("ProjectDisplayPresenter", HelpRessources.PROJECTDISPLAYPRESENTER);
		HelpRessources.PRESENTER_HELP.put("ProjectSelectSystemPresenter", HelpRessources.PROJECTSELECTSYSTEMPRESENTER);
		HelpRessources.PRESENTER_HELP.put("ProjectHistoryPresenter", HelpRessources.PROJECTHISTORYPRESENTER);
		HelpRessources.PRESENTER_HELP.put("IncidentTypeCreatePresenter", HelpRessources.INCIDENTTYPECREATEPRESENTER);
		HelpRessources.PRESENTER_HELP.put("CreateIncidentPresenter", HelpRessources.CREATEINCIDENTPRESENTER);
		HelpRessources.PRESENTER_HELP.put("Projektreleasesverwalten", HelpRessources.PROJEKTRELEASESVERWALTEN);
		HelpRessources.PRESENTER_HELP.put("ReleaseCreatePresenter", HelpRessources.RELEASECREATEPRESENTER);
		HelpRessources.PRESENTER_HELP.put("ReleaseEditPresenter", HelpRessources.RELEASEEDITPRESENTER);
		HelpRessources.PRESENTER_HELP.put("ReleaseBurndownChart", HelpRessources.RELEASEBURNDOWNCHART);
		HelpRessources.PRESENTER_HELP.put("Projektsprintsverwalten", HelpRessources.PROJEKTSPRINTSVERWALTEN);
		HelpRessources.PRESENTER_HELP.put("CreateSprintPresenter", HelpRessources.CREATESPRINTPRESENTER);
		HelpRessources.PRESENTER_HELP.put("EditSprintPresenter", HelpRessources.EDITSPRINTPRESENTER);
		HelpRessources.PRESENTER_HELP.put("SprintBurndownChart", HelpRessources.SPRINTBURNDOWNCHART);
		HelpRessources.PRESENTER_HELP.put("TaskboardPresenter", HelpRessources.TASKBOARDPRESENTER);
		HelpRessources.PRESENTER_HELP.put("TaskCreatePresenter", HelpRessources.TASKCREATEPRESENTER);
		HelpRessources.PRESENTER_HELP.put("Taskboardverwalten1", HelpRessources.TASKBOARDVERWALTEN1);
		HelpRessources.PRESENTER_HELP.put("ProductBacklog_Topic", HelpRessources.PRODUCTBACKLOG_TOPIC);
		HelpRessources.PRESENTER_HELP.put("ProductBacklogPresenter", HelpRessources.PRODUCTBACKLOGPRESENTER);
		HelpRessources.PRESENTER_HELP.put("ProductBacklogItemCreatePresente",
				HelpRessources.PRODUCTBACKLOGITEMCREATEPRESENTE);
		HelpRessources.PRESENTER_HELP.put("GenericTicketPresenter", HelpRessources.GENERICTICKETPRESENTER);
		HelpRessources.PRESENTER_HELP.put("Verwaltung", HelpRessources.VERWALTUNG);
		HelpRessources.PRESENTER_HELP.put("PersonRolePresenter", HelpRessources.PERSONROLEPRESENTER);
		HelpRessources.PRESENTER_HELP.put("PersonCreatePresenter", HelpRessources.PERSONCREATEPRESENTER);
		HelpRessources.PRESENTER_HELP.put("PersonEditPresenter", HelpRessources.PERSONEDITPRESENTER);
		HelpRessources.PRESENTER_HELP.put("RoleCreatePresenter", HelpRessources.ROLECREATEPRESENTER);
		HelpRessources.PRESENTER_HELP.put("TeamPresenter", HelpRessources.TEAMPRESENTER);
		HelpRessources.PRESENTER_HELP.put("TeamCreatePresenter", HelpRessources.TEAMCREATEPRESENTER);
		HelpRessources.PRESENTER_HELP.put("TeamEditPresenter", HelpRessources.TEAMEDITPRESENTER);
		HelpRessources.PRESENTER_HELP.put("VelocityAnalyse", HelpRessources.VELOCITYANALYSE);
		HelpRessources.PRESENTER_HELP.put("RevisionControlPresenter", HelpRessources.REVISIONCONTROLPRESENTER);
		HelpRessources.PRESENTER_HELP.put("StateFieldAndTickettypeAdministr",
				HelpRessources.STATEFIELDANDTICKETTYPEADMINISTR);
		HelpRessources.PRESENTER_HELP.put("TicketTypeCreatePresenter", HelpRessources.TICKETTYPECREATEPRESENTER);
		HelpRessources.PRESENTER_HELP.put("StateTypeCreatePresenter1", HelpRessources.STATETYPECREATEPRESENTER1);
		HelpRessources.PRESENTER_HELP.put("FieldTypeCreatePresenter1", HelpRessources.FIELDTYPECREATEPRESENTER1);
		HelpRessources.PRESENTER_HELP.put("TicketTypeSelectionPresenter", HelpRessources.TICKETTYPESELECTIONPRESENTER);
		HelpRessources.PRESENTER_HELP.put("TypeEditPresenter", HelpRessources.TYPEEDITPRESENTER);
		HelpRessources.PRESENTER_HELP.put("AddStatesToTicketTypePresenter",
				HelpRessources.ADDSTATESTOTICKETTYPEPRESENTER);
		HelpRessources.PRESENTER_HELP.put("AddFieldsToTicketTypePresenter",
				HelpRessources.ADDFIELDSTOTICKETTYPEPRESENTER);
		HelpRessources.PRESENTER_HELP.put("StateTransistionCreatePresenter",
				HelpRessources.STATETRANSISTIONCREATEPRESENTER);
		HelpRessources.PRESENTER_HELP.put("SystemManagementPresenter", HelpRessources.SYSTEMMANAGEMENTPRESENTER);
		HelpRessources.PRESENTER_HELP.put("UserManagementPresenter", HelpRessources.USERMANAGEMENTPRESENTER);
		HelpRessources.PRESENTER_HELP.put("UserCreatePresenter", HelpRessources.USERCREATEPRESENTER);
		HelpRessources.PRESENTER_HELP.put("Verwaltung1", HelpRessources.VERWALTUNG1);
		HelpRessources.PRESENTER_HELP.put("SearchAllPresenter", HelpRessources.SEARCHALLPRESENTER);
		HelpRessources.PRESENTER_HELP.put("SearchResultPresenter", HelpRessources.SEARCHRESULTPRESENTER);
		HelpRessources.PRESENTER_HELP.put("SearchPresenter", HelpRessources.SEARCHPRESENTER);
		HelpRessources.PRESENTER_HELP.put("SearchesPresenter", HelpRessources.SEARCHESPRESENTER);
	}
	...
	public static String getPresenterHelp(final Presenter presenter) {
		return HelpRessources.PRESENTER_HELP.get(ClassUtils.getClassName(presenter.getClass()));
	}
