...
public abstract class ExceptionConstants {
	 ...
	 */
	public static final String DOUBLE_DEFINITION_ERROR =
			"Doppelte Einträge sind nicht erlaubt! Bitte überprüfen!";
	/**
	 * Represents the text of the ForbiddenStateException.
	 */
	public static final String FORBIDDEN_STATE_ERROR =
			"Der aktuelle Status des Tickets erlaubt diese Aktion nicht";
	...
	public static final String EMPTY_DESCRIPTION_ERROR =
			"Es muss ein Beschreibung angegeben werden.";

	/**
	 * Represents the text of the Exception thrown if a selected role isn't related to a
	 * person.
	 */
	public static final String ROLE_NOT_FOUND_ERROR =
			"Diese Rolle ist dieser Person nicht zugewiesen.";

	/**
	 * Represents the text of the Exception thrown if a selected person doesn't exist in
	 * the team.
	 */
	public static final String PERSON_NOT_FOUND_ERROR =
			"Diese Person ist dem Team nicht zugewiesen.";

	/**
	 * Represents the text of the Exception thrown if a role is already related to a
	 * person.
	 */
	public static final String ROLE_ALREADY_ASSIGNED_ERROR =
			"Diese Rolle wurde der Person bereits zugeordnet.";

	/**
	 * Represents the text of the Exception thrown if a person is already related to a
	 * team.
	 */
	public static final String PERSON_ALREADY_ASSIGNED_ERROR =
			"Diese Person wurde dem Team bereits zugeordnet.";

	/**
	 * Represents the text of the Exception thrown if a role should be deleted that is
	 * still related to one or more persons.
	 */
	 ...
	 */
	public static final String NO_TEAM_SELECTED_ERROR =
			"Es muss ein Team zugeordnet werden.";

	/**
	 * Represents the text of the Exception thrown if the date chosen is not valid.
	 */
	public static final String NO_VALID_DATE_ERROR =
			"Es wurde ein ungültiges Datum angegeben.";

	/**
	 * Represents the text of the Exception thrown if the description is not valid.
	 */
	public static final String NO_VALID_NAME =
			"Es muss eine Bezeichnung angegeben werden";

	/**
	 * Represents the text of the Exception thrown if the date representing the end is
	 * before the date representing the start.
	 */
	public static final String END_BEFORE_BEGIN_ERROR =
	...
	public static final String EMPTY_NAME_ERROR =
			"Es muss ein vollständiger Name angegeben werden.";

	/**
	 * Represents the text of the Exception thrown if the name of a sprint is to short or
	 * to long.
	 */
	public static final String SPRINT_NAME_ERROR =
			"Der Name des Sprints muß eine Länge zwischen 1 und 20 besitzen.";
	...
	/**
	 * Represents the text of the Exception thrown if the state of a task doesn't allow
	...
	/**
	 * Represents the text of the Exception thrown if the chosen PBI doesn't exist in the
	 * sprint.
	 */
	...
	/**
	 * Represents the text of the Exception thrown if the chosen system doesn't exist in
	 * the project.
	 */
	public static final String SYSTEM_IS_NOT_POSSIBLE =
			"System ist nicht als mögliches System im Projekt definiert.";

	/**
	 * Represents the text of the Exception thrown if a release doesn't belong to the
	 * chosen project.
	 */
	public static final String RELEASE_NOT_IN_PROJECT =
			"Release gehört nicht zum übergeordneten Projekt!";

	/**
	 * Represents the text of the Exception thrown if a effort is less than 0.
	 */
	public static final String EFFORT_MIN_VALUE =
			"Aufwand darf nicht weniger als 0 betragen!";

	/**
	 * Represents the text of the Exception thrown if a search criterion couldn't be
	 * created.
	 */
	public static final String SEARCH_NOT_POSSIBLE =
			"Suchkriterium kann nicht erstellt werden";

	/**
	 * Represents the text of the Exception thrown if a search mussn't be updated.
	 */
	public static final String SEARCH_NOT_UPDATEABLE =
			"Suche darf nicht bearbeitet werden";
	 ...
	 */
	public static final String NO_CHANGE_ON_STANDARDS =
			"Änderungen am Standard sind nicht erlaubt!";
	/**
	 * represents an error message when you try to assign a team to a sprint, but the team
	 * does not contain the project.
	 */
	public static final String TEAM_NOT_ASSIGNED_ERROR =
			"Team ist diesem Projekt nicht zugeordnet!";
	/**
	 * represents an error message when you try to set the active role of a person that is
	 * not contained in person.getRoles().
	 */
	public static final String NO_SUCH_ROLE_ERROR =
			"Diese Rolle gehört nicht zu diesem Benutzer!";
	/**
	 ...
	 */
	public static final String STATE_NOT_DEFINDED =
