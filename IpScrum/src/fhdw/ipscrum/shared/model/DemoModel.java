...
public class DemoModel extends Root {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3712849590555653262L;

	public DemoModel() {
		super();

		final Root root = this;
		...
		try {
			...
			final Release phase3 = new Release("Phase III", new Date(
					2011 - 1900, 3 - 1, 9), ipScrum);

			// Initial Sprints
			final Date sprint1BeginDate = CalendarUtils
			...
			final Date sprint2BeginDate = CalendarUtils
					.getRandomDateOfThisMonth();
			...
			final Date sprint6BeginDate = CalendarUtils
					.getRandomDateOfThisMonth();
			...
			final Date sprint7BeginDate = CalendarUtils
					.getRandomDateOfThisMonth();
			...
			final Date sprint8BeginDate = CalendarUtils
					.getRandomDateOfThisMonth();
			...
			final Date sprint9BeginDate = CalendarUtils
					.getRandomDateOfThisMonth();
			...
			final Date sprint10BeginDate = CalendarUtils
					.getRandomDateOfThisMonth();
			...
			final Feature f4 = new Feature("Feature 4",
					"Beschreibung Feature 4", projekt1.getBacklog());
			f4.setLastEditor(pNils);
			f4.setManDayCosts(12);
			f4.setSprint(sprint3rel10);

			final Feature f5 = new Feature("Feature 5",
					"Beschreibung Feature 5", projekt1.getBacklog());
			f5.setLastEditor(pNils);
			f5.setManDayCosts(10);
			f5.setSprint(sprint5rel10);

			final Feature f6 = new Feature("Feature 6",
					"Beschreibung Feature 6", projekt1.getBacklog());
			f6.setLastEditor(pNils);
			f6.setManDayCosts(5);
			f6.setSprint(sprint2rel10);

			final Feature f7 = new Feature("Feature 7",
					"Beschreibung Feature 7", projekt2.getBacklog());
			f7.setLastEditor(pNils);
			f7.setManDayCosts(7);
			f7.setSprint(sprint7rel20);

			final Feature f8 = new Feature("Feature 8",
					"Beschreibung Feature 8", projekt2.getBacklog());
			f8.setLastEditor(pNils);
			f8.setManDayCosts(9);
			f8.setSprint(sprint7rel20);

			final Feature f9 = new Feature("Sprint-BDChart",
