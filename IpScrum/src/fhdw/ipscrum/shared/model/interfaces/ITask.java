...
/**
 * A Task represents an activity which realizes one or more Product Backlog
 * Items. A Task has a state of Type ITaskState.
 */
public interface ITask extends ITaskStateOperations, BDACompare {
	...
	/**
	 * @return estimated plan effort of the task. The value may be 0, if no
