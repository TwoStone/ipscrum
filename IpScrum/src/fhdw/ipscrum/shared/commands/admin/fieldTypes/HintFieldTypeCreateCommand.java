...
public class HintFieldTypeCreateCommand extends Command<HintFieldType>
	...
	private HintFieldTypeCreateCommand() {
		super();
	}
	 ...
	 *            of the new FieldType
	 */
	public HintFieldTypeCreateCommand(final String name, final Multiplicity multiplicity) {
		super();
		this.name = name;
	...
	public void accept(final CommandVisitor v) {
		v.handleHintFieldTypeCreateCommand(this);
	}
