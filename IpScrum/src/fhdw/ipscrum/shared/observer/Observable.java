...
/**
 * <p>
 * This class represents an observable object, or "data" in the model-view paradigm. It
 ...
 * calling the Observable's notifyObservers method causes all of its observers to be
 ...
 * implementation provided in the Observable class will notify Observers in the order in
 * which they registered interest, but subclasses may change this order, use no guaranteed
 * order, deliver notifications on separate threads, or may guarantee that their subclass
 ...
 * observers are considered the same if and only if the equals method returns true for
 * them.
 * </p>
 * <p>
...
public abstract class Observable implements IsSerializable, IObservable {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see fhdw.ipscrum.shared.observer.IObservable#addObserver(fhdw.ipscrum.shared
	 ...
	 * (non-Javadoc)
	 * 
	 * @see fhdw.ipscrum.shared.observer.IObservable#deleteObserver(fhdw.ipscrum.
	 * shared.observer.TransientObserver)
	 */
	@Override
	 ...
	 * 
	 * @see fhdw.ipscrum.shared.observer.IObservable#deleteObserver(fhdw.ipscrum.
	 * shared.observer.PersistentObserver)
	 */
	@Override
