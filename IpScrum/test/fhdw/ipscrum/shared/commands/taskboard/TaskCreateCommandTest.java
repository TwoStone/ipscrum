...
/**
 * The class <code>TaskCreateCommandTest</code> contains tests for the class <code>{@link TaskCreateCommand}</code>.
 */
public class TaskCreateCommandTest {
	...
	/**
	 * Run the TaskCreateCommand(String,String,TaskTicketType,SprintBacklog) constructor test.
	 * 
	 * @throws Exception
	 *             if one of the used methods fails
	 */
	@Test
	public void testTaskCreateCommand1() throws Exception {
		final String name = "t1";
		final String description = "t1";
		final TaskTicketType taskTicketType = this.task;
		final SprintBacklog sprintBacklog = this.sprintbl;

		final TaskCreateCommand result = new TaskCreateCommand(name, description, taskTicketType, sprintBacklog);
	...
	public void testAccept1() throws Exception {
		final TaskCreateCommand fixture = new TaskCreateCommand("t2", "t2", this.task, this.sprintbl);
	...
	public void testDependsOnProject1() throws Exception {
		final TaskCreateCommand fixture = new TaskCreateCommand("t3", "t3", this.task, this.sprintbl);
	...
	public void testGetDependingProject1() throws Exception {
		final TaskCreateCommand fixture = new TaskCreateCommand("t4", "t4", this.task, this.sprintbl);
	...
	public void testGetDependingProject2() throws Exception {
		final TaskCreateCommand fixture = new TaskCreateCommand("t5", "t5", this.task, this.sprintbl);
	...
	/**
	 * Run the Task onExecute(Model) method test.
	 * 
	 * @throws Exception
	 *             if one of the used methods fails
	 */
	...
	public void testOnExecute1() throws Exception {
		final TaskCreateCommand fixture = new TaskCreateCommand("t6", "t6", this.task, this.sprintbl);

		final Task result = fixture.onExecute(this.model);
		Assert.assertNotNull(result);
	}
	...
	public void testOnExecute2() throws Exception {
		final TaskCreateCommand fixture = new TaskCreateCommand("", "", this.task, this.sprintbl);
	...
	public void testOnExecute3() throws Exception {
		final TaskCreateCommand fixture = new TaskCreateCommand("Beschreibung", "Task 1", this.task, this.sprintbl);

		final Task result = fixture.onExecute(this.model);

		Assert.assertNotNull(this.t1);
		Assert.assertNotNull(result);
	}
	...
	public void testOnExecute4() throws Exception {
		final TaskCreateCommand fixture = new TaskCreateCommand("t9", "t9", this.task, this.sprintbl);
	...
	public void testOnExecute5() throws Exception {
		final TaskCreateCommand fixture = new TaskCreateCommand("", "t11", this.task, this.sprintbl);
