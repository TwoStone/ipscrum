...
public class TaskSetPlanEffortCommandTest {
	...
	public void testTaskSetPlanEffortCommand1() throws Exception {
		...
		final Effort effort = new Effort(new Integer(1));
	...
	public void testAccept1() throws Exception {
		final TaskSetPlanEffortCommand fixture = new TaskSetPlanEffortCommand(this.t6, new Effort(new Integer(1)));
	...
	public void testDependsOnProject1() throws Exception {
		final TaskSetPlanEffortCommand fixture = new TaskSetPlanEffortCommand(this.t1, new Effort(new Integer(1)));
	...
	public void testOnExecute4() throws Exception {
		final TaskSetPlanEffortCommand fixture = new TaskSetPlanEffortCommand(this.t6, new Effort(new Integer(10)));
