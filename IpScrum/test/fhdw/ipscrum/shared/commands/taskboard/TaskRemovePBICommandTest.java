...
/**
 * The class <code>TaskRemovePBICommandTest</code> contains tests for the class
 * <code>{@link TaskRemovePBICommand}</code>.
 */
public class TaskRemovePBICommandTest {
	/**
	...
	/**
	 * Run the TaskRemovePBICommand(Task,ProductBacklogItem) constructor test.
	 * 
	 * @throws Exception
	 *             if one of the used methods fails
	 */
	@Test
	public void testTaskRemovePBICommand1() throws Exception {
		final Task task1 = this.t1;
		final ProductBacklogItem pbi = this.pbi1;

		final TaskRemovePBICommand result = new TaskRemovePBICommand(task1, pbi);
	...
	public void testAccept1() throws Exception {
		final TaskRemovePBICommand fixture = new TaskRemovePBICommand(this.t1, this.pbi1);
	...
	public void testGetDependingProject3() throws Exception {
		final TaskRemovePBICommand fixture = new TaskRemovePBICommand(this.t1, this.pbi2);
	...
	public void testOnExecute3() throws Exception {
		final TaskRemovePBICommand fixture = new TaskRemovePBICommand(null, this.pbi1);
	...
	public void testOnExecute5() throws Exception {
		final TaskRemovePBICommand fixture = new TaskRemovePBICommand(this.t6, this.pbi2);
