...
/**
 * The class <code>IncidentVacationCreateCommandTest</code> contains tests for the class
 * <code>{@link IncidentVacationCreateCommand}</code>.
 */
public class IncidentVacationCreateCommandTest {
	/**
	...
	/**
	 * Run the IncidentVacationCreateCommand(Date,Date,Person) constructor test.
	 * 
	 * @throws Exception
	 *             if one of the used methods fails
	 */
	@Test
	public void testIncidentVacationCreateCommand1() throws Exception {
		final Date startDate = new Date();
		final Date endDate = new Date();
		final Person person = this.per1;

		final IncidentVacationCreateCommand result = new IncidentVacationCreateCommand(startDate, endDate, person);
	...
	public void testAccept1() throws Exception {
		final IncidentVacationCreateCommand fixture =
				new IncidentVacationCreateCommand(new Date(), new Date(), this.per2);
	...
	public void testDependsOnProject1() throws Exception {
		final IncidentVacationCreateCommand fixture =
				new IncidentVacationCreateCommand(new Date(), new Date(), this.per1);
	...
	public void testOnExecute3() throws Exception {
		final IncidentVacationCreateCommand fixture = new IncidentVacationCreateCommand(new Date(), new Date(), null);
		final OneParticipantIncident result = fixture.onExecute(this.model);
	...
	public void setUp() throws Exception {
		...
		final IncidentType illness = new IncidentType(this.model, "Urlaub");
