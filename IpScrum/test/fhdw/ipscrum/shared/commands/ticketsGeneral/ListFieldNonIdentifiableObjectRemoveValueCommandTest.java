...
/**
 * The class <code>ListFieldNonIdentifiableObjectRemoveValueCommandTest</code> contains tests for the class
 * <code>{@link ListFieldNonIdentifiableObjectRemoveValueCommand}</code>.
 */
public class ListFieldNonIdentifiableObjectRemoveValueCommandTest {
	/**
	...
	/**
	 * Run the ListFieldNonIdentifiableObjectRemoveValueCommand(ListField<T>,T,Ticket) constructor test.
	 * 
	 * @throws Exception
	 *             if one of the used methods fails
	 */
	@Test
	public void testListFieldNonIdentifiableObjectRemoveValueCommand1() throws Exception {
		final ListField<Serializable> field = this.listField;
		final Ticket ticket = this.t1;

		@SuppressWarnings({ "rawtypes", "unchecked" })
		final ListFieldNonIdentifiableObjectRemoveValueCommand result =
				new ListFieldNonIdentifiableObjectRemoveValueCommand(field, JTextField.notifyAction, ticket);
	...
	public void testGetValue1() throws Exception {
		@SuppressWarnings({ "rawtypes", "unchecked" })
		final ListFieldNonIdentifiableObjectRemoveValueCommand fixture =
				new ListFieldNonIdentifiableObjectRemoveValueCommand(this.listField, JTextField.notifyAction, this.pbi1);
