...
/**
 * The class <code>SingleFieldNonIdentifiableObjectChangeCommandTest</code> contains tests for the class
 * <code>{@link SingleFieldNonIdentifiableObjectChangeCommand}</code>.
 */
public class SingleFieldNonIdentifiableObjectChangeCommandTest {
	/**
	...
	/**
	 * Run the SingleFieldNonIdentifiableObjectChangeCommand(SingleField<T>,T,Ticket) constructor test.
	 * 
	 * @throws Exception
	 *             if one of the used methods fails
	 */
	@Test
	public void testSingleFieldNonIdentifiableObjectChangeCommand1() throws Exception {

		final SingleField<Serializable> field = this.singleField;
		final Ticket ticket = this.t1;

		@SuppressWarnings({ "rawtypes", "unchecked" })
		final SingleFieldNonIdentifiableObjectChangeCommand result =
				new SingleFieldNonIdentifiableObjectChangeCommand(field, JTextField.notifyAction, ticket);
	...
	public void testGetValue1() throws Exception {
		@SuppressWarnings({ "rawtypes", "unchecked" })
		final SingleFieldNonIdentifiableObjectChangeCommand fixture =
				new SingleFieldNonIdentifiableObjectChangeCommand(this.singleField, "blaa", this.t1);
	...
	public void setUp() throws Exception {
		...
		this.singleField = new SingleField<Serializable>(this.model, this.model.getAllFieldTypes().get(0));
	}
