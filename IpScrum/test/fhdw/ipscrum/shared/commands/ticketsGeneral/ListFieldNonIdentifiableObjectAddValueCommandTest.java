...
/**
 * The class <code>ListFieldNonIdentifiableObjectAddValueCommandTest</code> contains tests for the class
 * <code>{@link ListFieldNonIdentifiableObjectAddValueCommand}</code>.
 */
public class ListFieldNonIdentifiableObjectAddValueCommandTest {
	/**
	...
	/**
	 * Run the ListFieldNonIdentifiableObjectAddValueCommand(ListField<T>,T,Ticket) constructor test.
	 * 
	 * @throws Exception
	 *             if one of the used methods fails
	 */
	@Test
	public void testListFieldNonIdentifiableObjectAddValueCommand1() throws Exception {
		final ListField<Serializable> field = this.listField;
		final Ticket ticket = this.t1;

		@SuppressWarnings({ "rawtypes", "unchecked" })
		final ListFieldNonIdentifiableObjectAddValueCommand result =
				new ListFieldNonIdentifiableObjectAddValueCommand(field, JTextField.notifyAction, ticket);
	...
	public void testGetValue1() throws Exception {
		@SuppressWarnings({ "rawtypes", "unchecked" })
		final ListFieldNonIdentifiableObjectAddValueCommand fixture =
				new ListFieldNonIdentifiableObjectAddValueCommand(this.listField, JTextField.notifyAction, this.pbi3);
