...
/**
 * The class <code>SingleFieldIdentifiableObjectChangeCommandTest</code> contains tests for the class
 * <code>{@link SingleFieldIdentifiableObjectChangeCommand}</code>.
 */
public class SingleFieldIdentifiableObjectChangeCommandTest {
	/**
	...
	/**
	 * Run the SingleFieldIdentifiableObjectChangeCommand(SingleField<T>,T,Ticket) constructor test.
	 * 
	 * @throws Exception
	 *             if one of the used methods fails
	 */
	@Test
	public void testSingleFieldIdentifiableObjectChangeCommand1() throws Exception {
		final SingleField<Serializable> field = this.singleField;
		final Ticket ticket = this.pbi1;

		@SuppressWarnings({ "rawtypes", "unchecked" })
		final SingleFieldIdentifiableObjectChangeCommand result =
				new SingleFieldIdentifiableObjectChangeCommand(field, this.per1, ticket);
	...
	public void testGetValue1() throws Exception {
		@SuppressWarnings({ "rawtypes", "unchecked" })
		final SingleFieldIdentifiableObjectChangeCommand fixture =
				new SingleFieldIdentifiableObjectChangeCommand(this.singleField, this.per2, this.t1);
	...
	public void testGetValue2() throws Exception {
		@SuppressWarnings({ "rawtypes", "unchecked" })
		final SingleFieldIdentifiableObjectChangeCommand fixture =
				new SingleFieldIdentifiableObjectChangeCommand(this.singleField, this.pbltest, this.pbi1);
	...
	public void setUp() throws Exception {
		...
		this.singleField = new SingleField<Serializable>(this.model, this.model.getAllFieldTypes().get(5));
	}
