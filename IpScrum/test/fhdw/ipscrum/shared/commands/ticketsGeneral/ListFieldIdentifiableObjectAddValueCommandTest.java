...
/**
 * The class <code>ListFieldIdentifiableObjectAddValueCommandTest</code> contains tests for the class
 * <code>{@link ListFieldIdentifiableObjectAddValueCommand}</code>.
 */
public class ListFieldIdentifiableObjectAddValueCommandTest {
	/**
	...
	/**
	 * Run the ListFieldIdentifiableObjectAddValueCommand(ListField<T>,T,Ticket) constructor test.
	 * 
	 * @throws Exception
	 *             if one of the used methods fails
	 */
	@Test
	public void testListFieldIdentifiableObjectAddValueCommand1() throws Exception {

		final ListField<Serializable> field = this.listField;
		final Ticket ticket = this.t1;

		@SuppressWarnings({ "rawtypes", "unchecked" })
		final ListFieldIdentifiableObjectAddValueCommand result =
				new ListFieldIdentifiableObjectAddValueCommand(field, this.per2, ticket);
	...
	public void testGetValue1() throws Exception {
		@SuppressWarnings({ "rawtypes", "unchecked" })
		final ListFieldIdentifiableObjectAddValueCommand fixture =
				new ListFieldIdentifiableObjectAddValueCommand(this.listField, this.sprint, this.pbi2);
	...
	public void testGetValue2() throws Exception {
		@SuppressWarnings({ "rawtypes", "unchecked" })
		final ListFieldIdentifiableObjectAddValueCommand fixture =
				new ListFieldIdentifiableObjectAddValueCommand(this.listField, this.per2, this.pbi2);
