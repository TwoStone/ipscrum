...
public class SprintBacklogTest extends SetUpTestData {
	...
	public void testCalculateOverallTaskEffort() {
		...
		assertEquals(15, this.pro1rel1spr1.getSprintBacklog()
				.calculateOverallTaskEffort());
		assertEquals(24, this.pro1rel1spr2.getSprintBacklog()
				.calculateOverallTaskEffort());
		assertEquals(35, this.pro1rel1spr3.getSprintBacklog()
				.calculateOverallTaskEffort());
		assertEquals(17, this.pro1rel1spr4.getSprintBacklog()
				.calculateOverallTaskEffort());
		assertEquals(21, this.pro1rel1spr5.getSprintBacklog()
				.calculateOverallTaskEffort());

		// Overall Task Efforts of Sprint 1 to Sprint 5 from Project1 Release2
		assertEquals(32, this.pro1rel2spr1.getSprintBacklog()
				.calculateOverallTaskEffort());
		assertEquals(23, this.pro1rel2spr2.getSprintBacklog()
				.calculateOverallTaskEffort());
		assertEquals(35, this.pro1rel2spr3.getSprintBacklog()
				.calculateOverallTaskEffort());
		assertEquals(13, this.pro1rel2spr4.getSprintBacklog()
				.calculateOverallTaskEffort());
		assertEquals(40, this.pro1rel2spr5.getSprintBacklog()
				.calculateOverallTaskEffort());

		// Overall Task Efforts of Sprint 1 to Sprint 5 from Projekt2 Release1
		assertEquals(22, this.pro2rel1spr1.getSprintBacklog()
				.calculateOverallTaskEffort());
		assertEquals(15, this.pro2rel1spr2.getSprintBacklog()
				.calculateOverallTaskEffort());
		assertEquals(20, this.pro2rel1spr3.getSprintBacklog()
				.calculateOverallTaskEffort());
		assertEquals(26, this.pro2rel1spr4.getSprintBacklog()
				.calculateOverallTaskEffort());
		assertEquals(21, this.pro2rel1spr5.getSprintBacklog()
				.calculateOverallTaskEffort());

		// Overall Task Efforts of Sprint 1 to Sprint 5 from Project2 Release1
		assertEquals(25, this.pro2rel2spr1.getSprintBacklog()
				.calculateOverallTaskEffort());
		assertEquals(25, this.pro2rel2spr2.getSprintBacklog()
				.calculateOverallTaskEffort());
		assertEquals(25, this.pro2rel2spr3.getSprintBacklog()
				.calculateOverallTaskEffort());
		assertEquals(25, this.pro2rel2spr4.getSprintBacklog()
				.calculateOverallTaskEffort());
		assertEquals(25, this.pro2rel2spr5.getSprintBacklog()
				.calculateOverallTaskEffort());
