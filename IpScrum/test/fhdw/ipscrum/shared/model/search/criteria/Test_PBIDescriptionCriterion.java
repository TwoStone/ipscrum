...
public class Test_PBIDescriptionCriterion {
	...
	PBIDescriptionCriterion desCrit = new PBIDescriptionCriterion("Fehler");
	assertEquals("Fehler", desCrit.getValue());
	}
	
	
	@Test
	/**
	 * Search, if a Bug Description contains a certain String
	 * Description does contain the string
	 */
	
	public void testsearch1() throws Exception{
		PBIDescriptionCriterion desCrit = new PBIDescriptionCriterion("Fehler"); 
		assertEquals(true, desCrit.search(pbi4));
	}
	...
	public void testsearch2() throws Exception{
		PBIDescriptionCriterion desCrit = new PBIDescriptionCriterion("Feature"); 
		assertEquals(false, desCrit.search(pbi4));
	}

	@Test
	/**
	 * Search, if a Feature Description contains a certain String
	 * Description does contain the string
	 */
	
	public void testsearch3() throws Exception{
		PBIDescriptionCriterion desCrit = new PBIDescriptionCriterion("Texte");
		assertEquals(true, desCrit.search(pbi1));
	}
	
	@Test
	/**
	 * Search, if a Feature Description contains a certrain string
	 * Description does not contain the string
	 */
	
	public void testsearch4() throws Exception{
		PBIDescriptionCriterion desCrit = new PBIDescriptionCriterion("Fehler");
		assertEquals(false, desCrit.search(pbi1));
	}
