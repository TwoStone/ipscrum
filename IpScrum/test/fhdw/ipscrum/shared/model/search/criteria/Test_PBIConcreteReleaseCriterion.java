...
public class Test_PBIConcreteReleaseCriterion {
	...
	public void testconstructor() throws Exception{
		PBIConcreteReleaseCriterion crCrit = new PBIConcreteReleaseCriterion(release1); 
		assertEquals(release1, crCrit.getRelease());
	}
	...
	public void testsearch2() throws Exception{
		PBIConcreteReleaseCriterion crCrit = new PBIConcreteReleaseCriterion(release2);
		assertFalse(crCrit.search(pbi4));
	}
	...
	public void testsearch4() throws Exception{
		PBIConcreteReleaseCriterion crCrit = new PBIConcreteReleaseCriterion(release2);
		assertFalse(crCrit.search(pbi1));
	}
