...
public class Test_PBIFeatureTypeCriterion {
	...
	@Test
	/**
	 * Search, if a PBI is a Feature
	 * PBI is a Feature
	 */
	
	public void testsearch1() throws Exception{
		PBIFeatureTypeCriterion ftCrit = new PBIFeatureTypeCriterion(); 
		assertTrue(ftCrit.search(pbi1));
	}
	...
	public void testsearch2() throws Exception{
		PBIFeatureTypeCriterion ftCrit = new PBIFeatureTypeCriterion();  
		assertFalse(ftCrit.search(pbi4));
	}
