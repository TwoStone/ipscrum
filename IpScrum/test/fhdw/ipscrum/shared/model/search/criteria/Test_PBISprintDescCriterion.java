...
public class Test_PBISprintDescCriterion {
	...
	@Test
	/**
	 * Search, if a Sprint description contains a certain string
	 * the Sprint contains the string
 	 * PBI to search is a Bug
	 */
	
	public void testsearch1() throws Exception{
		PBISprintDescCriterion sdCrit = new PBISprintDescCriterion("Beschreibung"); 
		assertTrue(sdCrit.search(pbi4));
	}
	
	@Test
	/**
	 * Search, if a Sprint description contains a certain string
	 * The sprint does not contain the string
	 * PBI to search is a Bug
	 */
	
	public void testsearch2() throws Exception{
		PBISprintDescCriterion sdCrit = new PBISprintDescCriterion("Feature"); 
		assertFalse(sdCrit.search(pbi4));
	}
	 ...
	 * Search, if a Sprint description contains a certain string
	 * the Sprint contains the string
	 * PBI to search is a Feature
	 */
	
	public void testsearch3() throws Exception{
		PBISprintDescCriterion sdCrit = new PBISprintDescCriterion("Beschreibung"); 
		assertTrue(sdCrit.search(pbi1));
	}
	...
	public void testsearch4() throws Exception{
		PBISprintDescCriterion sdCrit = new PBISprintDescCriterion("Feature"); 
		assertFalse(sdCrit.search(pbi1));
	}
