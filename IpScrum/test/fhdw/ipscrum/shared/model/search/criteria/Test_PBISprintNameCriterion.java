...
public class Test_PBISprintNameCriterion {
	...
	@Test
	/**
	 * Search, if a Sprint name contains a certain string
	 * the Sprint contains the string
 	 * PBI to search is a Bug
	 */
	
	public void testsearch1() throws Exception{
		PBISprintNameCriterion snCrit = new PBISprintNameCriterion("Sprint"); 
		assertTrue(snCrit.search(pbi4));
	}
	...
	public void testsearch2() throws Exception{
		PBISprintNameCriterion snCrit = new PBISprintNameCriterion("Feature"); 
		assertFalse(snCrit.search(pbi4));
	}
	...
	public void testsearch4() throws Exception{
		PBISprintNameCriterion snCrit = new PBISprintNameCriterion("Feature"); 
		assertFalse(snCrit.search(pbi1));
	}
