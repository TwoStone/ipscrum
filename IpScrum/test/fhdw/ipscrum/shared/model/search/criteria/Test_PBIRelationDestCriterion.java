...
public class Test_PBIRelationDestCriterion {
	...
	@Test
	/**
	 * Search, if a Bug has a specific relation destination
	 * Bug does have that relation destination
	 */
	
	public void testsearch1() throws Exception{
		PBIRelationDestCriterion rdCrit = new PBIRelationDestCriterion("Farben"); 
		assertTrue(rdCrit.search(pbi4));
	}
	
	@Test
	/**
	 * Search, if a Bug has a specific relation destination
	 * Bug does not have that relation destination
	 */
	
	public void testsearch2() throws Exception{
		PBIRelationDestCriterion rdCrit = new PBIRelationDestCriterion("In Bezug auf"); 
		assertFalse(rdCrit.search(pbi4));
	}

	@Test
	/**
	 * Search, if a Feature has a specific relation destination
	 * Feature does have that relation destination
	 * Feature has only one relation destination
	 */
	
	public void testsearch3() throws Exception{
		PBIRelationDestCriterion rdCrit = new PBIRelationDestCriterion("Texte");
		assertTrue(rdCrit.search(pbi2));
	}
	 ...
	 * Search, if a Feature has a specific relation destination
	 * Feature does have that relation destination
	 * Feature has more than one relation destination
	 */
	
	public void testsearch4() throws Exception{
		PBIRelationDestCriterion rdCrit = new PBIRelationDestCriterion("Texte");
		assertTrue(rdCrit.search(pbi3));
	}
	
	@Test
	/**
	 * Search, if a Feature has a specific relation destination
	 * Feature does not have that relation destination
	 * Feature has only one relation destination
	 */
	
	public void testsearch5() throws Exception{
		PBIRelationDestCriterion rdCrit = new PBIRelationDestCriterion("Bezug nehmend auf");
		assertFalse(rdCrit.search(pbi1));
	}
	...
	public void testsearch6() throws Exception{
		PBIRelationDestCriterion rdCrit = new PBIRelationDestCriterion("Bezug nehmend auf");
		assertFalse(rdCrit.search(pbi3));
	}
