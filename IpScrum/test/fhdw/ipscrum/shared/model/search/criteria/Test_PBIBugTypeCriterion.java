...
public class Test_PBIBugTypeCriterion {
	...
	@Test
	/**
	 * Search, if a PBI is a Bug
	 * PBI is a Bug
	 */
	
	public void testsearch1() throws Exception{
		PBIBugTypeCriterion btCrit = new PBIBugTypeCriterion(); 
		assertTrue(btCrit.search(pbi4));
	}
	...
	public void testsearch2() throws Exception{
		PBIBugTypeCriterion btCrit = new PBIBugTypeCriterion();  
		assertFalse(btCrit.search(pbi1));
	}
