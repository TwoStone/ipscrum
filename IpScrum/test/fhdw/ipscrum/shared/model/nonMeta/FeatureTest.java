...
public class FeatureTest {
	...
	public void setUp() throws Exception {
		...
		this.ftype =
				new FeatureTicketType(this.model, "TestFeature", "TestFeatureType");
		...
		this.feature1 =
				new Feature(this.model, this.ftype, this.featureName1,
						this.featureDescription1, this.productBacklog);
		this.feature2 =
				new Feature(this.model, this.ftype, this.featureName2,
						this.featureDescription1, this.productBacklog);
	}
	...
	public void addAcceptanceCriterion() throws Exception {
		...
		Assert.assertFalse(this.feature1.getAcceptanceCriteria().listIterator()
				.hasNext());
		this.feature1.addAcceptanceCriterion(acceptanceCriterion);
		Assert.assertTrue(this.feature1.getAcceptanceCriteria().listIterator()
				.hasNext());
		Assert.assertEquals(acceptanceCriterion, this.feature1.getAcceptanceCriteria()
				.listIterator().next());
	}

	/**
	 * tests to add the same acceptance criterion twice to check if the exception is
	 * thrown.
	 * 
	 * @throws Exception
	 *             if the use of one of the methods fails
	...
	/**
	 * tests to ad the identical acceptance criterion twice to check if the exception is
	 * thrown.
	 * 
	 * @throws Exception
	 *             if the use of one of the methods fails
	...
	/**
	 * tests to add a acceptance criterion to a feature which is in a sets this is
	...
	/**
	 * tests to add two identical hints to the feature to check if the exception is
	 * thrown.
	 * 
	 * @throws Exception
	 *             if the use of one of the methods fails
	...
	/**
	 * tests to add a hint to a feature which is in a state this is forbidden to check if
	...
	/**
	 * tests to add a relation to a feature in a state this is forbidden to check if the
	 * exception is thrown.
	 * 
	 * @throws Exception
	 *             if the use of one of the methods fails
	...
	public void addRelationToOtherFeatureWithoutNewRelationType() throws Exception {
		...
		Assert.assertTrue(this.feature1.getRelations().iterator().hasNext());
		Assert.assertEquals(relation, this.feature1.getRelations().iterator().next());
		Assert.assertEquals(this.rtype, this.feature1.getRelations().iterator().next()
				.getType());
	...
	public void addRelationToOwnFeatureWithNewRelationType() throws Exception {
		...
		this.feature1.addRelation(relation);
		Assert.assertEquals(relationType, this.feature1.getRelations().iterator()
				.next().getType());
	}

	/**
	 * tests to close a feature in a state this is forbidden to check if the exception is
	 * thrown.
	 * 
	 * @throws Exception
	 *             if the use of one of the methods fails
	...
	@Test(expected = fhdw.ipscrum.shared.exceptions.model.ForbiddenStateException.class)
	public
			void closeAlreadyClosedFeature() throws Exception {
		this.feature1.changeState(this.typeManager.getClosed());
		this.feature1.changeState(this.typeManager.getClosed());
	}
	...
	public void closeFeature() throws Exception {
		this.feature1.changeState(this.typeManager.getClosed());
		Assert.assertTrue(this.feature1.getCurrentState() == this.typeManager
				.getClosed());
	}
	...
	/**
	 * tests to create a feature which has the same name as another to check if the
	 * exception is thrown.
	 * 
	 * @throws Exception
	 *             if the use of one of the methods fails
	...
	@Test(expected = fhdw.ipscrum.shared.exceptions.model.DoubleDefinitionException.class)
	public
			void createFeatureDoubleFeatureInSameBacklog() throws Exception {
		new Feature(this.model, this.ftype, "TestName", "TestDescription",
				this.productBacklog);
		new Feature(this.model, this.ftype, "TestName", "TestDescription",
				this.productBacklog);
	...
	/**
	 * tests to remove an acceotance criterion from a feature which is in a state this is
	 * forbidden to check if the exception is thrwon.
	 * 
	 * @throws Exception
	 *             if the use of one of the methods fails
	 * 
	...
	@Test(expected = fhdw.ipscrum.shared.exceptions.model.ForbiddenStateException.class)
	public
			void removeAcceptanceCriterionToClosedFeature() throws Exception {
		final String acceptanceCriterion = "TestAcceptanceCriterion";
	...
	/**
	 * tests to remove a hint from a feature which is in a state this is forbidden to
	...
	@Test(expected = fhdw.ipscrum.shared.exceptions.model.ForbiddenStateException.class)
	public
			void removeHintToClosedFeature() throws Exception {
		final String hint = "TestHint";
	...
	/**
	 * tests to remove the relation from a feature which is in a state this is forbidden
	 * to check if the exceptionis thrown.
	 * 
	 * @throws Exception
	 *             if the use of one of the methods fails
	 * 
	...
	@Test(expected = fhdw.ipscrum.shared.exceptions.model.ForbiddenStateException.class)
	public
			void removeRelationToClosedFeature() throws Exception {
	...
	/**
	 * Tests to change the description of a feature which is in a state this is forbidden
	 * th check if the exception is thrown.
	 * 
	 * @throws Exception
	 *             if the use of one of the methods fails
	 * 
	...
	@Test(expected = fhdw.ipscrum.shared.exceptions.model.ForbiddenStateException.class)
	public
			void setDescriptionToClosedFeature() throws Exception {
	...
	/**
	 * Tests to change the last editor in a feature which is in a state this is forbidden
	 * to check if the excception is thrown.
	 * 
	 * @throws Exception
	 *             if the use of one of the methods fails
	 * 
	...
	@Test(expected = fhdw.ipscrum.shared.exceptions.model.ForbiddenStateException.class)
	public
			void setLastEditorToClosedFeature() throws Exception {
	...
	/**
	 * Tests to set the effort of a feature which is in a state this is forbidden to check
	...
	@Test(expected = fhdw.ipscrum.shared.exceptions.model.ForbiddenStateException.class)
	public
			void setManDayCostsToClosedFeature() throws Exception {
	...
	/**
	 * Tests to add a sprint to a feature in a state this is forbidden to check if the
	 * exception is thrown.
	 * 
	 * @throws Exception
	 *             if the use of one of the methods fails
	...
	@Test(expected = fhdw.ipscrum.shared.exceptions.model.ForbiddenStateException.class)
	public
			void setSprintToClosedFeature() throws Exception {
		...
		final Sprint sprint1 =
				new Sprint(this.model, "TestName1", "TestDescription1", begin, end,
						tteam1, tproject);
	...
	public void setSprintToOpenFeature() throws Exception {
		...
		final Sprint sprint2 =
				new Sprint(this.model, "TestName2", "TestDescription2", begin, end,
						tteam2, tproject2);
