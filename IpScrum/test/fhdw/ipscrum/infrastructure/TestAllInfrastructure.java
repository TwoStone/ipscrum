 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({ TransactionExecutionTest.class })
public final class TestAllInfrastructure {
	/**
	 * constructor of the TestAllInfrastructure.
	 */
	private TestAllInfrastructure() {
