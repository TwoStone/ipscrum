...
/**
 * A Field represents a standard or additional attribute of a ticket. Nearly all attributes of tickets are modeled as
 * fields. a field can be single- or multi-valued. Fields may not be instantiated externally, because that must be done
 * by the field-type, which determines the type-specific content of the field. fields are referenced by instances of
 * Ticket. Furthermore, tickets are wrappers for values type T.
 * 
 * @param <T>
