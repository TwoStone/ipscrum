 ...
 */
public class TicketTypeRemoveStateTypeCommand extends Command<Void> implements ITicketTypesCommand {
	 ...
	 *            related to the command
	 */
	public TicketTypeRemoveStateTypeCommand(final TicketType receiver, final StateType statetype) {
		super(receiver);
	...
	protected Void onExecute(final Model model) throws IPScrumGeneralException {
		...
		this.setStringValue(StringUtils.format("Dem Tickettypen %s wurde der Zustand %s entfernt.",
